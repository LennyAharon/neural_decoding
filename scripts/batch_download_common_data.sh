#!/bin/bash
# Batch download common data for multiple EIDs
#
# Usage:
#   ./scripts/batch_download_common_data.sh
...
EIDS=(
    ...
    # "1735d2be-b388-411a-896a-60b01eaa1cfe" # doesn't have probs data 
    # "3638d102-e8b6-4230-8742-e548cd87a949"
    # "6899a67d-2e53-4215-a52a-c7021b5da5d4"
    # "8928f98a-b411-497e-aa4b-aa752434686d"
    # # 21 videos for segmentation 
    # "1735d2be-b388-411a-896a-60b01eaa1cfe", #1
    ...
    # "c7b0e1a3-4d4d-4a76-9339-e73d0ed5425b" # didn't work
...
# Pose model path to use for trial filtering (shared across all sessions)
# This should point to a directory containing pose predictions (e.g., CSV files)
POSE_MODEL_DIR="test_200_MVT_3d_aug_patch_masking_new/eks_multiview_linear"
POSE_MODEL_PATH="${POSE_BASE_PATH}/${POSE_MODEL_DIR}/videos_new"
...
echo "========================================"
echo "Batch Downloading Common Data"
echo "========================================"
echo "EIDs: ${#EIDS[@]}"
echo "Pose Model Path: $POSE_MODEL_PATH"
echo ""
...
for eid in "${EIDS[@]}"; do
    ...
    python src/download_common_data.py \
        --eid "$eid" \
        --base_path "$BASE_PATH" \
...
# 1. chmod +x scripts/batch_download_common_data.sh
# 2. ./scripts/batch_download_common_data.sh
